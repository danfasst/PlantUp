package br.edu.up.plantup.ui.theme.screens.visualbar
...
fun BottomBar(navController: NavController) {
    ...
    NavigationBar(containerColor = VerdeEscuro) {
        ...
        NavigationBarItem(
            selected = currentRoute == PlantUpRoutes.SCREEN_REMINDER_ROUTE,
            onClick = {
                navController.navigate(PlantUpRoutes.SCREEN_REMINDER_ROUTE)
            },
